...
%% Latin超立方抽样参数：
nS = 1e5;nS1 = 1e4;K_ =1420 ;n_ = 0.08;Kt = 2.32; % 若优化后由应力得出的应变大了，可将n_调小一点！或者把K_再调大一点！
...
%% 优化后的应变和应力样本：
% RSM模型优化后应变的均值和方差：
RSM_mu = 0.005557026346655; RSM_sigma = 1.1556e-04;
...
fid=fopen('D_strain_data.txt','wt');%写入文件路径
[m,n]=size(a); 
 for i=1:1:m
    for j=1:1:n
       if j==n
