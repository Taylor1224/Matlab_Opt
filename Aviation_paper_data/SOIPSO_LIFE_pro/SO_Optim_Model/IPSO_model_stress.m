...
%% 导出优化前后寿命的样本：
fid = fopen('sigma_B1_LIFE0.5.txt','wt');      % wt有重新写入的作用
fprintf(fid,'%g\n',Life_x); 
fid = fopen('sigma_B1_LIFE0.9.txt','wt');
fprintf(fid,'%g\n',Life_y); 
fid = fopen('sigma_B1_LIFE0.95.txt','wt');
fprintf(fid,'%g\n',Life_z); 
fid = fopen('sigma_B1_LIFE0.5_optim.txt','wt');
fprintf(fid,'%g\n',Life_Optim_x); 
fid = fopen('sigma_B1_LIFE0.9_optim.txt','wt');
fprintf(fid,'%g\n',Life_Optim_y); 
fid = fopen('sigma_B1_LIFE0.95_optim.txt','wt');
fprintf(fid,'%g\n',Life_Optim_z); 
